...
main_window_geometry = cPickle.loads('\x80\x02csip\n_unpickle_type\nq\x01U\x0cPyQt5.QtCoreq\x02U\nQByteArrayU2\x01\xd9\xd0\xcb\x00\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x12\x00\x00\x05U\x00\x00\x02\xff\x00\x00\x00\x00\x00\x00\x003\x00\x00\x06\xaf\x00\x00\x026\x00\x00\x00\x00\x02\x00\x00\x00\x05V\x85\x87Rq\x03.')
...
plugin_search_history = cPickle.loads('\x80\x02]q\x01(X\x06\x00\x00\x00Kindleq\x02X\n\x00\x00\x00Collectionq\x03X\x03\x00\x00\x00Tagq\x04e.')
